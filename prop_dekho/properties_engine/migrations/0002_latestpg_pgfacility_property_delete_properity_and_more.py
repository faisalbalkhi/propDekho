    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('girls_boys', models.CharField(choices=[('for girls&boys', 'for girls&boys'), ('All prepared', 'All prepared')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='PgFacility',
        ...
        migrations.AddField(
            model_name='latestpg',
            name='key_facilities',
            field=models.ManyToManyField(related_name='latestpg_keyfacilities', to='properties_engine.pgfacility'),
        ),
    ]
