    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maintainance_charges', models.FloatField(blank=True, null=True)),
                ...
                ('property_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='property_type', to='properties_engine.propertytype')),
            ],
            options={
